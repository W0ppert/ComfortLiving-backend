...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 23 okt 2024 om 11:08
...
CREATE TABLE `klanten` (
  ...
  `bewijs_jaarinkomen` varchar(255) NOT NULL,
  `voorkeur_plaats` varchar(255) NOT NULL,
  ...
  `klant_aanmaak_datum` date DEFAULT NULL,
...
(1, '', 'Stegeman', '', '', '', '0000-00-00', '', NULL, NULL, '', '', NULL, '', NULL, NULL, NULL, ''),
(2, '', 'Starreveld', '', '', '', '0000-00-00', '', NULL, NULL, '', '', NULL, '', NULL, NULL, NULL, ''),
(3, '', 'hoer', '', '', '', '0000-00-00', '', NULL, NULL, '', '', NULL, '', NULL, NULL, NULL, ''),
...
--
-- Tabelstructuur voor tabel `mytable`
--

CREATE TABLE `mytable` (
  `MyEuroColumn` varchar(5) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `panden` (
  ...
  `bij_voegsel` varchar(2) NOT NULL,
  ...
  `aangeboden_sinds` date NOT NULL DEFAULT current_timestamp(),
...
(1, 'Dorpslaan', '12', '', '8000AZ', 'Zwolle', '', 0, 'Supermooie vrijstaande gezinswoning, met een redelijke grote tuin!\r\nHet is gelegen in een kind vriendelijke buurt en het is op een steenworp afstand van het winkelcentrum in Zwolle! ', 0, '', 0, '2024-10-21', 'huur', ''),
(2, 'Dorpslaan', '23', '', '8000AX', 'Zwolle', '', 0, 'Super mooie vrijstaande een persoons woning. Het is niet het meest grootste huis maar het is een prima huis voor 1 of 2 personen! Het centrum is zo\'n circa 15 minuten fietsen. Daarnaast is de bakker ook nog is om de hoek!\r\n\r\nJe redt het prima in je eentje!', 0, '', 0, '2024-10-21', 'huur', ''),
(3, 'Hoofdstraat', '1', '', '1234 A', 'Amsterdam', '', 0, 'Een mooie woning met uitzicht op het water.', 0, '', 0, '2024-10-21', 'koop', ''),
(4, 'Dorpsstraat', '12', '', '2345 B', 'Utrecht', '', 0, 'Gezellige eengezinswoning met tuin.', 0, '', 0, '2024-10-21', 'recreatie', ''),
(5, 'Kerklaan', '5', '', '3456 C', 'Rotterdam', '', 0, 'Moderne woning in een rustige buurt.', 0, '', 0, '2024-10-21', 'koop', ''),
(6, 'Burgemeesterstraat', '8', '', '4567 D', 'Den Haag', '', 0, 'Charmante woning nabij het centrum.', 0, '', 0, '2024-10-21', 'koop', ''),
(7, 'Lindenlaan', '15', '', '5678 E', 'Eindhoven', '', 0, 'Ruime woning met veel lichtinval.', 0, '', 0, '2024-10-21', 'huur', ''),
(8, 'Vijverweg', '20', '', '6789 F', 'Groningen', '', 0, 'Prachtige woning met tuin en zwembad.', 0, '', 0, '2024-10-21', 'huur', ''),
(9, 'Achterweg', '22', '', '7890 G', 'Maastricht', '', 0, 'Luxe appartement met balkon en uitzicht.', 0, '', 0, '2024-10-21', 'koop', ''),
(10, 'Bosweg', '30', '', '8901 H', 'Nijmegen', '', 0, 'Gezellige bungalow in een groene omgeving.', 0, '', 0, '2024-10-21', 'koop', ''),
(11, 'Zonstraat', '18', '', '9012 I', 'Leiden', '', 0, 'Charmante woning met originele details.', 0, '', 0, '2024-10-21', 'recreatie', ''),
(12, 'Zilverlaan', '2', '', '0123 J', 'Haarlem', '', 0, 'Moderne stadswoning met dakterras.', 0, '', 0, '2024-10-21', 'koop', ''),
(13, 'Eikenlaan', '4', '', '1234 K', 'Tilburg', '', 0, 'Riante eengezinswoning met garage.', 0, '', 0, '2024-10-21', 'recreatie', ''),
(14, 'Hofstraat', '6', '', '2345 L', 'Almere', '', 0, 'Ruime woning met zonnepanelen.', 0, '', 0, '2024-10-21', 'huur', ''),
(15, 'Heuvelweg', '8', '', '3456 M', 'Breda', '', 0, 'Statige villa in een rustige wijk.', 0, '', 0, '2024-10-21', 'huur', ''),
(16, 'Westerstraat', '10', '', '4567 N', 'Haarlemmermeer', '', 0, 'Karakteristieke woning met tuin.', 0, '', 0, '2024-10-21', 'huur', ''),
(17, 'Plataanweg', '12', '', '5678 O', 'Dordrecht', '', 0, 'Instapklare woning met moderne afwerking.', 0, '', 0, '2024-10-21', 'huur', ''),
(18, 'Oostlaan', '14', '', '6789 Q', 'Leeuwarden', '', 0, 'Huis met veel ruimte en een fijne tuin.', 0, '', 0, '2024-10-21', 'recreatie', ''),
(19, 'Westersingel', '16', '', '7890 R', 'Den Bosch', '', 0, 'Woning met historische elementen en modern comfort.', 0, '', 0, '2024-10-21', 'huur', ''),
(20, 'Noordweg', '17', '', '8901 S', 'Hengelo', '', 0, 'Leuke starterswoning met leuke buurt.', 0, '', 0, '2024-10-21', 'koop', ''),
(21, 'Zuidlaan', '19', '', '9012 T', 'Enschede', '', 0, 'Woning met ruime kamers en een open keuken.', 0, '', 0, '2024-10-21', 'koop', ''),
(22, 'Tuinweg', '21', '', '0123 U', 'Helmond', '', 0, 'Nette woning met een zonnige tuin.', 0, '', 0, '2024-10-21', 'huur', ''),
(23, 'Laan van Meerdervoort', '23', '', '1234 V', 'Arnhem', '', 0, 'Ruime gezinswoning nabij school en park.', 0, '', 0, '2024-10-21', 'koop', ''),
(24, 'Kloosterstraat', '25', '', '2345 W', 'Amersfoort', '', 0, 'Klassieke woning met moderne upgrades.', 0, '', 0, '2024-10-21', 'huur', ''),
(25, 'Steenweg', '27', '', '3456 X', 'Gouda', '', 0, 'Huis met veel karakter en een grote tuin.', 0, '', 0, '2024-10-21', 'koop', ''),
(26, 'Molenstraat', '29', '', '4567 Y', 'Utrecht', '', 0, 'Leuke hoekwoning met een balkon.', 0, '', 0, '2024-10-21', 'huur', ''),
(27, 'Windsingel', '31', '', '5678 A', 'Hoofddorp', '', 0, 'Fijne woning met veel lichtinval.', 0, '', 0, '2024-10-21', 'huur', ''),
(28, 'Kasteelweg', '33', '', '6789 B', 'Amstelveen', '', 0, 'Moderne villa met grote oprit en tuin.', 0, '', 0, '2024-10-21', 'koop', ''),
(29, 'Dorpsplein', '35', '', '7890 C', 'Leiden', '', 0, 'Schitterende woning in het hart van het dorp.', 0, '', 0, '2024-10-21', 'recreatie', ''),
(30, 'Havenstraat', '37', '', '8901 D', 'Groningen', '', 0, 'Prachtig appartement met uitzicht op de haven.', 0, '', 0, '2024-10-21', 'recreatie', ''),
(31, 'Rivierenlaan', '39', '', '9012 E', 'Den Haag', '', 0, 'Instapklare woning met een nette afwerking.', 0, '', 0, '2024-10-21', 'koop', ''),
(32, 'Schapenweg', '41', '', '0123 F', 'Almere', '', 0, 'Zeer ruime woning met moderne keuken.', 0, '', 0, '2024-10-21', 'huur', ''),
(33, 'Fazantenlaan', '43', '', '1234 G', 'Breda', '', 0, 'Luxe villa in een rustige straat.', 0, '', 0, '2024-10-21', 'huur', ''),
(34, 'Heuvelweg', '45', '', '2345 H', 'Utrecht', '', 0, 'Woning met grote tuin en schuurtje.', 0, '', 0, '2024-10-21', 'huur', ''),
(35, 'Kraaienlaan', '47', '', '3456 I', 'Tilburg', '', 0, 'Gezellige eengezinswoning met garage.', 0, '', 0, '2024-10-21', 'koop', ''),
(36, 'Valkenhorst', '49', '', '4567 J', 'Den Bosch', '', 0, 'Charmante woning met een heerlijke tuin.', 0, '', 0, '2024-10-21', 'koop', ''),
(37, 'Rozenlaan', '51', '', '5678 K', 'Haarlem', '', 0, 'Moderne woning met zonnepanelen.', 0, '', 0, '2024-10-21', 'recreatie', ''),
(38, 'Bovenweg', '53', '', '6789 L', 'Nijmegen', '', 0, 'Licht en ruim appartement met balkon.', 0, '', 0, '2024-10-21', 'koop', ''),
(39, 'Oudeweg', '55', '', '7890 M', 'Gouda', '', 0, 'Instapklare woning in een rustige buurt.', 0, '', 0, '2024-10-21', 'huur', ''),
(40, 'Dijkstraat', '57', '', '8901 N', 'Haarlemmermeer', '', 0, 'Woning met een grote tuin en terras.', 0, '', 0, '2024-10-21', 'huur', ''),
(41, 'Bovenweg', '59', '', '9012 O', 'Enschede', '', 0, 'Nette woning dichtbij het centrum.', 0, '', 0, '2024-10-21', 'huur', ''),
(42, 'Weteringstraat', '61', '', '0123 P', 'Dordrecht', '', 0, 'Ruime woning met veel slaapkamers.', 0, '', 0, '2024-10-21', 'huur', ''),
(43, 'Zevenheuvelen', '63', '', '1234 Q', 'Leeuwarden', '', 0, 'Zeer ruime woning met garage en tuin.', 0, '', 0, '2024-10-21', 'koop', ''),
(44, 'Zuidwal', '65', '', '2345 R', 'Maastricht', '', 0, 'Prachtige villa met uitzicht op de Maas.', 0, '', 0, '2024-10-21', 'koop', ''),
(45, 'Hoogstraat', '67', '', '3456 S', 'Hengelo', '', 0, 'Moderne woning met ruime woonkamer.', 0, '', 0, '2024-10-21', 'koop', ''),
(46, 'Kerklaan', '69', '', '4567 T', 'Breda', '', 0, 'Charmante woning met karakter.', 0, '', 0, '2024-10-21', 'recreatie', ''),
(47, 'Weg naar beneden', '71', '', '5678 U', 'Amersfoort', '', 0, 'Fijne woning in een kindvriendelijke buurt.', 0, '', 0, '2024-10-21', 'recreatie', ''),
(48, 'Hoofdweg', '73', '', '6789 V', 'Almere', '', 0, 'Woning met moderne afwerking en tuin.', 0, '', 0, '2024-10-21', 'koop', ''),
(49, 'Spaarndammerstraat', '75', '', '7890 W', 'Groningen', '', 0, 'Ruime woning met een prachtige tuin.', 0, '', 0, '2024-10-21', 'huur', ''),
(50, 'Hoogstraat', '77', '', '8901 X', 'Den Haag', '', 0, 'Luxe appartement in een levendige buurt.', 0, '', 0, '2024-10-21', 'koop', ''),
(51, 'Beukenlaan', '79', '', '9012 Y', 'Tilburg', '', 0, 'Gezellige woning met veel karakter.', 0, '', 0, '2024-10-21', 'huur', '');
...
(2, 'Verwarming lekt', 2, 3, '2024-05-16 18:38:15', '2024-10-21');
