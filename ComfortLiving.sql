...
--
-- Host: 127.0.0.1
-- Generated on: 16 mei 2024 om 18:43
...
CREATE TABLE IF NOT EXISTS `externepartij` (
  `id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `serviceverzoek` (
  `id` int(11) NOT NULL,
  `omschrijving` varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `sv_stappen` (
  `id` int(11) NOT NULL,
  `omschrijving` varchar(255) NOT NULL,
...
ON DUPLICATE KEY UPDATE
  `omschrijving` = VALUES(`omschrijving`),
  `serviceverzoek_id` = VALUES(`serviceverzoek_id`),
  `externepartij_id` = VALUES(`externepartij_id`),
  `datum` = VALUES(`datum`);
